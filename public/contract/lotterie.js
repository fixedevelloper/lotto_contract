var lotto = function () {
    ...
    const register=async function(){
        ...
        const new_address=await getParentID($("#referralid").val());
        $.ajax({
                        ...
                        if (result.status === true) {
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    window.location.href=configs.routes.index+'?id='+id;
                                },
                                error: function (err) {
